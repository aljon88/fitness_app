  ...
  List<Recipe> _getLunchRecipes() {
    return [
      ...
      Recipe(
        ...
        ingredients: [
          Ingredient(name: 'Whole wheat tortilla', amount: 1, unit: 'large', isOptional: false, caloriesPerUnit: 130, seasonalMonths: []),
          Ingredient(name: 'Turkey breast', amount: 4, unit: 'oz', isOptional: false, caloriesPerUnit: 120, seasonalMonths: []),
          Ingredient(name: 'Avocado', amount: 0.5, unit: 'medium', isOptional: false, caloriesPerUnit: 120, seasonalMonths: []),
          Ingredient(name: 'Lettuce', amount: 1, unit: 'cup', isOptional: false, caloriesPerUnit: 5, seasonalMonths: []),
          Ingredient(name: 'Tomato', amount: 0.5, unit: 'medium', isOptional: false, caloriesPerUnit: 11, seasonalMonths: [6, 7, 8]),
          Ingredient(name: 'Mustard', amount: 1, unit: 'tsp', isOptional: true, caloriesPerUnit: 3, seasonalMonths: []),
        ],
        instructions: [
          'Lay tortilla flat on a clean surface',
          'Layer turkey slices in the center',
          'Add sliced avocado, lettuce, and tomato',
          'Spread mustard if desired',
      ...
      Recipe(
        ...
        description: 'Classic tuna salad on whole grain bread with crisp vegetables',
        ingredients: [
          Ingredient(name: 'Canned tuna', amount: 5, unit: 'oz', isOptional: false, caloriesPerUnit: 120, seasonalMonths: []),
          Ingredient(name: 'Whole grain bread', amount: 2, unit: 'slices', isOptional: false, caloriesPerUnit: 80, seasonalMonths: []),
          Ingredient(name: 'Mayonnaise', amount: 1, unit: 'tbsp', isOptional: false, caloriesPerUnit: 90, seasonalMonths: []),
          Ingredient(name: 'Celery', amount: 0.25, unit: 'cup', isOptional: false, caloriesPerUnit: 4, seasonalMonths: []),
          Ingredient(name: 'Red onion', amount: 2, unit: 'tbsp', isOptional: false, caloriesPerUnit: 8, seasonalMonths: []),
          Ingredient(name: 'Lettuce', amount: 2, unit: 'leaves', isOptional: false, caloriesPerUnit: 3, seasonalMonths: []),
        ],
        instructions: [
          'Drain tuna and place in a bowl',
          'Mix tuna with mayonnaise, diced celery, and red onion',
          'Season with salt and pepper to taste',
          'Toast bread if desired',
          'Spread tuna salad on bread and top with lettuce'
        ],
        nutrition: NutritionInfo(
          calories: 395,
          protein: 32,
          ...
          sugar: 4,
          sodium: 580,
          vitamins: {'D': 40, 'B12': 85},
          minerals: {'Selenium': 65, 'Omega-3': 500},
        ),
  ...
  List<Recipe> _getSnackRecipes() {
    return [
      ...
      Recipe(
        ...
        ingredients: [
          Ingredient(name: 'Greek yogurt', amount: 1, unit: 'cup', isOptional: false, caloriesPerUnit: 130, seasonalMonths: []),
          Ingredient(name: 'Mixed berries', amount: 0.5, unit: 'cup', isOptional: false, caloriesPerUnit: 40, seasonalMonths: [6, 7, 8]),
          Ingredient(name: 'Honey', amount: 1, unit: 'tsp', isOptional: true, caloriesPerUnit: 21, seasonalMonths: []),
          Ingredient(name: 'Granola', amount: 2, unit: 'tbsp', isOptional: true, caloriesPerUnit: 60, seasonalMonths: []),
        ],
        instructions: [
        ...
        nutrition: NutritionInfo(
          ...
          sugar: 22,
          sodium: 75,
          vitamins: {'C': 15, 'B12': 25},
          minerals: {'Calcium': 250, 'Potassium': 320},
        ),
      ...
      Recipe(
        ...
        ingredients: [
          Ingredient(name: 'Hummus', amount: 0.25, unit: 'cup', isOptional: false, caloriesPerUnit: 100, seasonalMonths: []),
          Ingredient(name: 'Carrots', amount: 1, unit: 'cup', isOptional: false, caloriesPerUnit: 50, seasonalMonths: []),
          Ingredient(name: 'Cucumber', amount: 0.5, unit: 'cup', isOptional: false, caloriesPerUnit: 8, seasonalMonths: [6, 7, 8]),
          Ingredient(name: 'Bell pepper', amount: 0.5, unit: 'cup', isOptional: true, caloriesPerUnit: 15, seasonalMonths: [7, 8, 9]),
        ],
        instructions: [
      ...
      Recipe(
        ...
        ingredients: [
          Ingredient(name: 'Rolled oats', amount: 0.5, unit: 'cup', isOptional: false, caloriesPerUnit: 150, seasonalMonths: []),
          Ingredient(name: 'Peanut butter', amount: 0.25, unit: 'cup', isOptional: false, caloriesPerUnit: 190, seasonalMonths: []),
          Ingredient(name: 'Honey', amount: 2, unit: 'tbsp', isOptional: false, caloriesPerUnit: 64, seasonalMonths: []),
          Ingredient(name: 'Chocolate chips', amount: 2, unit: 'tbsp', isOptional: false, caloriesPerUnit: 70, seasonalMonths: []),
          Ingredient(name: 'Chia seeds', amount: 1, unit: 'tbsp', isOptional: true, caloriesPerUnit: 60, seasonalMonths: []),
        ],
        instructions: [
